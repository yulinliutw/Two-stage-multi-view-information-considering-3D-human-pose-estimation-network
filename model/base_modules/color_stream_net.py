...
def Feature2D_extracter_model(outputchannel):
    ...
    # openpose Stage 1
    block4_2 = [{'conv5_1_CPM_L2': [128, 128, 3, 1, 1]},
                {'conv5_2_CPM_L2': [128, 128, 3, 1, 1]},
                {'conv5_3_CPM_L2': [128, 128, 3, 1, 1]},
                {'conv5_4_CPM_L2': [128, 512, 1, 1, 0]},
                {'conv5_5_CPM_L2': [512, 1, 1, 1, 0]}]
    ...
    models['block4_2'] = make_stages(block4_2)
    class rtpose_model(nn.Module):
        ...
        def forward(self, x):  
            ...
            #predict body center
            body_center = self.model4_2(feature_50x50)

...
#prepare dataset
for a in range(15):
    Mydataset = h36Dataset(config.dataset,config.dataset.val_image_set+'_A'+str(a+1)+'.csv',config.network,data_transforms)
    ...
    for i_batch, sample_batched in enumerate(My_data_loader):    
        ...
        print('Evualation done | iter:'+str(i_batch) + '|action:'+str(a+1))
